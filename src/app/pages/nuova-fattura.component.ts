    ...
    <form *ngIf="!loading" nz-form [formGroup]="validateForm" (ngSubmit)="submitForm()">
      ...
      <nz-form-item nz-row class="register-area">
        <nz-form-control [nzSpan]="14" [nzOffset]="6">
          <button nz-button nzType="primary">Inserisci Nuova Fattura</button>
        </nz-form-control>
      </nz-form-item>
...
export class NuovaFatturaComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private srvClienti: ClientiService, private srvFatt: FattureService) { }
